var Potion = function(game, options)
{
    ...
    this.build =function()
    {
        ...
        this.container_mesh.name='Potion';
		...
		var materials = game.assets.potion_mat;
        ...
        this.mesh = new THREE.SkinnedMesh( game.assets.potion_geo, new THREE.MultiMaterial(materials));
        this.mesh.scale.x=5;
        this.mesh.scale.y=5;
        this.mesh.scale.z=5;
        ...
        this.rotatingClip = game.assets.potion_geo.animations[1];
        this.rotate_action = this.mixer.clipAction(this.rotatingClip, null ).setDuration(5);
    ...
    {
        play_multiple(game.assets.potion_drop_sound);
    };
